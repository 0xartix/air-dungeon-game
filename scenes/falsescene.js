// False Scene Configuration - Wrong Answer
export const falsescene = {
    id: 'falsescene',
    image: 'falsescene.jpg',
    description: 'Wrong answer!',
    // Custom Dialog Configuration - Wrong Answer Scene
    customDialog: {
        enabled: true,
        question: ['That\'s false!', '-200 points'],
        buttons: [
            { text: 'Allright', action: 'goToScene12FromFalse', id: 'dialog_goToScene12FromFalse' }
        ],
        position: { 
            left: '68.5%', 
            top: '74%', 
