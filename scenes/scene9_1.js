// Scene 9_1 Configuration - Attack Result
export const scene9_1 = {
    id: 'scene9_1',
    image: 'scene9_1.jpg',
    description: 'The attack has consequences...',
    // Custom Dialog Configuration - FUD Death Scene
    customDialog: {
        enabled: true,
        question: ['FUD slashed you', '-100 HP'],
        buttons: [
            { text: 'Game Over', action: 'gameover_scene9_1', id: 'dialog_gameover_scene9_1' }
        ],
        position: { 
            left: '68.5%', 
            top: '74%', 
        ...
        questionPrefixIcon: {
            ...
            backgroundImage: 'url("skull2.png")',
