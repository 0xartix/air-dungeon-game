// Scene 4_1 Configuration - Snake Death Scene
export const scene4_1 = {
    id: 'scene4_1',
    image: 'snake2.png',
    description: 'You\'ve been strangled by the snake',
    // HP effect when entering this scene (optional - could set HP to 0)
    hpEffect: -100,  // Sets HP to 0 or very low to indicate death
    // Custom Dialog Configuration - Death Scene
    customDialog: {
        enabled: true,
        question: 'You\'ve been strangled by the snake',
        buttons: [
            { text: 'Game Over', action: 'gameover_scene4_1', id: 'dialog_gameover_scene4_1' }
        ],
        position: { 
            left: '68.5%', 
            top: '74%', 
